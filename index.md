...
4. Develop your profile using a Markdown and name it as `{yourname}.md`. Save your file under the `/profiles` directory. See [Nami's example]({site.pages.nami}). You can put anything you'd like there. Some suggestions:
   1. Your picture
   2. Bio
   3. Tech Stacks
   4. Hobbies
